...
const scenes: Scene[] = [
  {
    ...
    before: publicAsset("/images/home-before.jpg"),
    after: publicAsset("/images/home-after.jpg"),
    focal: "64% 62%",
  },
  {
    id: "estate",
    ...
    before: publicAsset("/images/estate-before.jpg"),
    after: publicAsset("/images/estate-after.jpg"),
    focal: "70% 70%",
  },
  {
    id: "hotel",
    ...
    before: publicAsset("/images/hotel-before.jpg"),
    after: publicAsset("/images/hotel-after.jpg"),
    focal: "40% 74%",
  },
  {
    id: "commercial",
    ...
    before: publicAsset("/images/commercial-before.jpg"),
    after: publicAsset("/images/commercial-after.jpg"),
    focal: "46% 76%",
  },
  {
    id: "public",
    ...
    before: publicAsset("/images/public-before.jpg"),
    after: publicAsset("/images/public-after.jpg"),
    focal: "58% 70%",
  },
];
...
const colours = [
  {
    ...
    swatch: "#6b4a2c",
    image: publicAsset("/images/home-after.jpg"),
    focal: "68% 76%",
  },
  {
    id: "red",
    ...
    swatch: "#7e2a18",
    image: publicAsset("/images/estate-after.jpg"),
    focal: "74% 76%",
  },
  {
    id: "black",
    ...
    swatch: "#23201d",
    image: publicAsset("/images/commercial-after.jpg"),
    focal: "50% 80%",
  },
];
    ...
    <main>
      ...
      <section className="section section--sand">
        <div className="shell environment-grid">
          <div className="environment-image"><img src={publicAsset("/images/public-after.jpg")} alt="Public walkway with decorative brown mulch" loading="lazy" decoding="async" /></div>
      ...
      <section className="section section--visualise" id="visualise">
        <div className="section--visualise__backdrop" style={{ backgroundImage: `linear-gradient(90deg, rgba(23,19,15,.3), rgba(23,19,15,.85)), url(${publicAsset("/images/estate-after.jpg")})` }} />
      ...
      <section className="final-cta">
        <img src={publicAsset("/images/public-after.jpg")} alt="Landscaped public walkway with decorative mulch" loading="lazy" decoding="async" />
